...
fn solve_tridiagonal_f64() {
    ...
    let a: Array2<f64> = arr2(&[[  3.0,   2.1,   0.0,   0.0,   0.0],
                                [  3.4,   2.3,  -1.0,   0.0,   0.0],
                                [  0.0,   3.6,  -5.0,   1.9,   0.0],
                                [  0.0,   0.0,   7.0,  -0.9,   8.0],
                                [  0.0,   0.0,   0.0,  -6.0,   7.1]]);
    let b: Array2<f64> = arr2(&[[  2.7,   6.6],
                                [ -0.5,  10.8],
                                [  2.6,  -3.2],
                                [  0.6, -11.2],
                                [  2.7,  19.1]]);
    let x: Array2<f64> = arr2(&[[ -4.0,   5.0],
                                [  7.0,  -4.0],
                                [  3.0,  -3.0],
                                [ -4.0,  -2.0],
                                [ -3.0,   1.0]]);
...
fn solve_tridiagonal_c64() {
    ...
    let a: Array2<c64> = arr2(&[[ c64::new( -1.3,   1.3), c64::new(  2.0,  -1.0), c64::new(  0.0,   0.0), c64::new(  0.0,   0.0), c64::new(  0.0,   0.0)],
                                [ c64::new(  1.0,  -2.0), c64::new( -1.3,   1.3), c64::new(  2.0,   1.0), c64::new(  0.0,   0.0), c64::new(  0.0,   0.0)],
                                [ c64::new(  0.0,   0.0), c64::new(  1.0,   1.0), c64::new( -1.3,   3.3), c64::new( -1.0,   1.0), c64::new(  0.0,   0.0)],
                                [ c64::new(  0.0,   0.0), c64::new(  0.0,   0.0), c64::new(  2.0,  -3.0), c64::new( -0.3,   4.3), c64::new(  1.0,  -1.0)],
                                [ c64::new(  0.0,   0.0), c64::new(  0.0,   0.0), c64::new(  0.0,   0.0), c64::new(  1.0,   1.0), c64::new( -3.3,   1.3)]]);
    let b: Array2<c64> = arr2(&[[ c64::new(  2.4,  -5.0), c64::new(  2.7,   6.9)],
    ...
    let x: Array2<c64> = arr2(&[[ c64::new(  1.0,   1.0), c64::new(  2.0,  -1.0)],
...
fn det_tridiagonal_f64() {
    let a: Array2<f64> = arr2(&[[ 10.0,  -9.0,   0.0],
                                [  7.0, -12.0,  11.0],
                                [  0.0,  10.0,   3.0]]);
...
fn rcond_tridiagonal_identity() {
    ...
    for rows in 2..6 { // cannot make 1x1 tridiagonal matrices.
